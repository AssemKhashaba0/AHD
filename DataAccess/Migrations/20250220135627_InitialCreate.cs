        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Orders_Cemeteries_CemeteryId",
                        column: x => x.CemeteryId,
                        principalTable: "Cemeteries",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Orders_Mosques_MosqueId",
                        column: x => x.MosqueId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_DeliveryAgents_Orders_AssignedOrderId",
                        column: x => x.AssignedOrderId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Recurrences_Orders_OrderId",
                        column: x => x.OrderId,
                        principalTable: "Orders",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DeliveryAgents_AssignedOrderId",
                table: "DeliveryAgents",
                column: "AssignedOrderId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Orders_CemeteryId",
                table: "Orders",
                column: "CemeteryId");

            migrationBuilder.CreateIndex(
                name: "IX_Orders_MosqueId",
                table: "Orders",
                column: "MosqueId");
